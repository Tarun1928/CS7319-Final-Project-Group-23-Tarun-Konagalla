...
# Entries Frame
entries_frame = Frame(root, bg="#F5DEB3")
entries_frame.pack(side=TOP, fill=X)
title = Label(entries_frame, text="Employee Management System", font=("Calibri", 18, "bold"), bg="#F5DEB3", fg="black")
title.grid(row=0, columnspan=2, padx=10, pady=20, sticky="w")

lblName = Label(entries_frame, text="Name", font=("Calibri", 16, "bold"), bg="#F5DEB3", fg="black")
lblName.grid(row=1, column=0, padx=10, pady=10, sticky="w")
txtName = Entry(entries_frame, textvariable=name, font=("Calibri", 16), width=30)
txtName.grid(row=1, column=1, padx=10, pady=10, sticky="w")


lblAge = Label(entries_frame, text="Age", font=("Calibri", 16, "bold"), bg="#F5DEB3", fg="black")
lblAge.grid(row=1, column=2, padx=10, pady=10, sticky="w")
txtAge = Entry(entries_frame, textvariable=age, font=("Calibri", 16, ), width=30)
txtAge.grid(row=1, column=3, padx=10, pady=10, sticky="w")

lbldoj = Label(entries_frame, text="D.O.J", font=("Calibri", 16, "bold"), bg="#F5DEB3", fg="black")
...
lblEmail = Label(entries_frame, text="Email", font=("Calibri", 16,"bold"), bg="#F5DEB3", fg="black")
lblEmail.grid(row=2, column=2, padx=10, pady=10, sticky="w")
txtEmail = Entry(entries_frame, textvariable=email, font=("Calibri", 16), width=30)
txtEmail.grid(row=2, column=3, padx=10, pady=10, sticky="w")

lblGender = Label(entries_frame, text="Gender", font=("Calibri", 16, "bold" ), bg="#F5DEB3", fg="black")
...
lblContact = Label(entries_frame, text="Contact No", font=("Calibri", 16, "bold"), bg="#F5DEB3", fg="black")
...
lblAddress = Label(entries_frame, text="Address", font=("Calibri", 16, "bold", "underline"), bg="#F5DEB3", fg="black")
